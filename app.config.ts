...
const rawBundleId = "com.daisheroique.travelguard";
const bundleId =
  rawBundleId
...
// Stable deep-link scheme owned by this app; it must not change between builds.
const schemeFromBundleId = "travelguard";
