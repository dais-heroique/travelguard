...
struct SafetyView: View {
    ...
    var body: some View {
        ...
        }.padding(20).padding(.bottom, 30) }.background(TGColor.ivory).navigationTitle("").navigationBarHidden(true).onAppear { if alertsEnabled { store.location.restoreProximityAlertsIfAuthorized() } } }
    }
}
''',
